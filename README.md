...
This application is designed to work exclusively with the **`PGSStats.json`** export file generated by the [**PGSharp**](https://www.pgsharp.com/) app — a modified Pokémon GO client.
